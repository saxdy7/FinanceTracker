...
import { TrendingUp, LayoutGrid, FileText, MessageSquare, Wallet, Activity, BarChart3, LogOut, Settings, Bell, Lock, Mail, User as UserIcon, Eye, EyeOff, Menu, X, Zap, CreditCard } from 'lucide-react';
import Link from 'next/link';
import { useRouter, usePathname } from 'next/navigation';
import { motion, AnimatePresence } from 'framer-motion';
import { containerVariants, itemVariants, headerVariants, sidebarVariants, contentVariants, formInputVariants } from '@/utils/animations';
      ...
      <main className="flex-1 lg:ml-64 overflow-auto">
        ...
        <div className="bg-white border-b border-gray-100 sticky top-0 z-20">
          <div className="px-4 sm:px-8 py-4 flex items-center justify-between">
            ...
            <h1 className="font-poppins font-bold text-lg sm:text-2xl text-gray-900">Settings</h1>
